...
import 'package:law_chamber/pages/claim_page.dart';
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              GestureDetector(
                child: CreditsButtonContainer(
                  buttonIcon: Icon(FontAwesomeIcons.solidCreditCard),
              ...
              CreditsButtonContainer(
                  ...
                  onClick: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ClientsFamePage()));
                  }),
              CreditsButtonContainer(
              ...
              CreditsButtonContainer(
                ...
                onClick: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => ActivityLogs()));
                },
              ),
            ],
          )
